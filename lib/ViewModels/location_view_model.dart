...
// import '../GPX/central_point_view_model.dart';
...
//
//       // 2. Process central points and clusters using CentralPointViewModel
//       final centralPointVM = Get.find<CentralPointViewModel>();
//       await centralPointVM.processGPXAndStoreCentralPoint();
//
...
//   }
//
//   // Combined method for daily processing
...
//
//       // Phir central points process karein using CentralPointViewModel
//       final centralPointVM = Get.find<CentralPointViewModel>();
//       await centralPointVM.processGPXAndStoreCentralPoint();
//
//       // Phir 24 hours data process karein
//       await centralPointVM.process24HoursGPXData();
//
...
// ✅ NEW: Check if location service is working
  ...
  Future<void> storeCentralPointsToAPI(
    ...
    try {
      ...
      // if (apiSuccess) {
      //   centralPoint.posted = 1;
      //   await centralPointsRepo.updateCentralPoint(centralPoint);
      //   debugPrint("✅ Enhanced central point successfully posted to API");
      // } else {
      //   debugPrint("⚠ Enhanced central point saved locally, will sync later");
      // }
...
// Manual counter reset (if needed)
  ...
  //     debugPrint("🟦 Storing enhanced central points to API...");
  //
  //     // 🔥🔥🔥 YEH FINAL FIX - DELETE OLD & CREATE NEW
  //     String today = DateFormat('yyyy-MM-dd').format(DateTime.now());
  //     var existingPoints = await centralPointsRepo.getCentralPoints();
  //
  //     // Purani entries DELETE karein sirf wohi jo same user ki hain aur aaj ki hain
  //     var todayPoints = existingPoints.where((point) =>
  //     point.processingDate == today &&
  //         point.userId == user_id).toList();
  //
  //     if (todayPoints.isNotEmpty) {
  //       debugPrint("🔄 Existing entries found for today - DELETING OLD & CREATING NEW");
  //
  //       for (var oldPoint in todayPoints) {
  //         if (oldPoint.centralPointId != null) {
  //           await centralPointsRepo.deleteCentralPoint(oldPoint.centralPointId!);
  ...
  //     String overallAddress = await _getAddressFromLatLng(overallCenter);
  //
  //     // 1. Enhanced cluster data preparation
  //     List<Map<String, dynamic>> clustersData = [];
  //
  //     for (var clusterKey in clusterCenters.keys) {
  //       LatLng center = clusterCenters[clusterKey]!;
  ...
  //       bookerName: userName,
  //       clusterData: jsonEncode(clustersData),
  //       posted: 0, // Start with 0, update after successful API call
  //       createdAt: DateTime.now().toIso8601String(),
  //       // New fields
  //       clusterArea: "${totalClusterArea.toStringAsFixed(4)} sq km",
  //       addressDistrict: overallAddress,
  ...
  //     );
  //
  //     // 4. Local database mein save karein
  //     await centralPointsRepo.addCentralPoint(centralPoint);
  //     debugPrint("💾 Enhanced central point saved to local database with ID: $uniqueId");
  //
  //     // 5. Wait for 1 second to ensure unique timestamp
  //     await Future.delayed(Duration(seconds: 1));
  //
  //     // 6. Immediately API mein post karein (Remote Config use karke)
  //     bool apiSuccess = await centralPointsRepo.postCentralPointToAPI(centralPoint);
  //
  //     if (apiSuccess) {
  //       // Agar API success toh posted status update karein
  //       centralPoint.posted = 1;
  //       await centralPointsRepo.updateCentralPoint(centralPoint);
  //       debugPrint("✅ Enhanced central point successfully posted to API");
  //     } else {
...
// // //   }
// // //
// // //   // Update getCurrentGPXFilePath method
// // //   Future<String> getCurrentGPXFilePath() async {
// // //     final downloadDirectory = await getDownloadsDirectory();
// // //     final date = DateFormat('dd-MM-yyyy').format(DateTime.now());
// // //     return '${downloadDirectory!.path}/$date.gpx';
// // //   }
// // //
// // // // Update getDailyGPXFileName method
// // // //   String getDailyGPXFileName() {
// // // //     final date = DateFormat('dd-MM-yyyy').format(DateTime.now());
// // // //     return 'track$date.gpx';
// // // //   }
...
// // //       final date = DateFormat('dd-MM-yyyy').format(DateTime.now());
// // //       final downloadDirectory = await getDownloadsDirectory();
// // //       final gpxFilePath = '${downloadDirectory!.path}/$date.gpx';
// // //
// // //       debugPrint("🟦 Starting enhanced GPX processing...");
// // //
// // //       // 1. Coordinates extract karein
...
// // //       CentralPointsModel centralPoint = CentralPointsModel(
// // //         centralPointId: centralPointsRepo.generateCentralPointId(),
// // //         userId: user_id,
// // //         overallCenterLat: overallCenter.latitude,
// // //         overallCenterLng: overallCenter.longitude,
// // //         totalClusters: clusterCenters.length,
...
// // //       );
// // //
// // //       // 3. Local database mein save karein
// // //       await centralPointsRepo.addCentralPoint(centralPoint);
// // //       debugPrint("💾 Enhanced central point saved to local database");
// // //
// // //       // 4. Immediately API mein post karein (Remote Config use karke)
// // //       bool apiSuccess = await centralPointsRepo.postCentralPointToAPI(centralPoint);
// // //
// // //       if (apiSuccess) {
// // //         // Agar API success toh posted status update karein
...
// // //       ) async {
// // //     debugPrint("⏱️ Calculating cluster stay times...");
// // //
// // //     Map<String, double> stayTimes = {};
// // //     Map<String, List<DateTime>> clusterTimestamps = {};
// // //
...
// // //     }
// // //
// // //     // Calculate stay time for each cluster
// // //     clusterTimestamps.forEach((clusterKey, timestamps) {
// // //       if (timestamps.length < 2) {
// // //         stayTimes[clusterKey] = 0.0;
// // //         return;
...
// // //
// // //       for (var currentTime in timestamps) {
// // //         if (previousTime != null) {
// // //           double timeDiff = currentTime.difference(previousTime).inMinutes.toDouble();
// // //
// // //           // Only count if time difference is less than threshold (continuous stay)
// // //           if (timeDiff <= timeThresholdMinutes) {
// // //             totalStayTime += timeDiff;
// // //           }
// // //         }
...
// // //
// // //       stayTimes[clusterKey] = totalStayTime;
// // //       debugPrint("⏱️ Cluster $clusterKey stay time: ${totalStayTime.toStringAsFixed(2)} minutes");
// // //     });
// // //
// // //     return stayTimes;
// // //   }
...
// // //
// // //   // Method 1: Basic location save (existing functionality)
// // //   // Replace existing saveLocation method
// // //   Future<void> saveLocation() async {
// // //     await saveDailyGPXToServer();
// // //   }
// // //
// // // // Replace existing saveLocationWithCentralPoints method
// // //   Future<void> saveLocationWithCentralPoints() async {
// // //     await saveDailyGPXToServer();
// // //     await processDailyGPXData();
// // //   }
// // //
// // // // Replace existing process24HoursGPXData method
// // //   Future<void> processDailyGPXData() async {
// // //     try {
// // //       // Sirf daily file use karein
// // //       final gpxFilePath = await getCurrentGPXFilePath();
// // //       debugPrint("🕐 Processing daily GPX data from: $gpxFilePath");
// // //
// // //       // 1. Extract all coordinates from today's file
// // //       List<LatLng> coordinates = await gpxService.extractCoordinatesFromGPX(gpxFilePath);
// // //
// // //       if (coordinates.isEmpty) {
// // //         debugPrint("❌ No coordinates found in daily data");
// // //         return;
// // //       }
// // //
// // //       debugPrint("📍 Total coordinates in daily file: ${coordinates.length}");
// // //
// // //       // 2. Extract all points with time data
// // //       List<Wpt> allPoints = await _extractAllPointsWithTime(gpxFilePath);
// // //
...
// // //       );
// // //
// // //       debugPrint("✅ Daily GPX processing completed");
// // //
// // //     } catch (e) {
// // //       debugPrint("❌ Error processing daily GPX data: $e");
// // //     }
// // //   }
// // //
// // //   // Method 2: Advanced save with central points processing
...
// // // //   Future<void> saveLocationWithCentralPoints() async {
// // // //     try {
// // // //       debugPrint("🟦 Starting enhanced location save with central points...");
// // // //
// // // //       // 1. Save daily GPX to server
// // // //       await saveDailyGPXToServer();
// // // //
// // // //       // 2. Process central points and clusters
// // // //       await processDailyGPXData();
// // // //
// // // //       debugPrint("✅ Enhanced location save with central points completed successfully");
// // // //
// // // //     } catch (e) {
// // // //       debugPrint("❌ Error in saveLocationWithCentralPoints: $e");
// // // //     }
...
// // //     return unposted.length;
// // //   }
// // //   // Daily GPX file ensure karne ka method
// // //   Future<void> ensureDailyGPXFile() async {
// // //     try {
// // //       final date = DateFormat('dd-MM-yyyy').format(DateTime.now());
// // //       final downloadDirectory = await getDownloadsDirectory();
// // //       final filePath = "${downloadDirectory!.path}/$date.gpx";
// // //
// // //       File dailyFile = File(filePath);
// // //
// // //       if (!dailyFile.existsSync()) {
// // //         // Create new daily file with proper structure
// // //         final gpxHeader = '''<?xml version="1.0" encoding="UTF-8"?>
// // // <gpx version="1.1" creator="OrderBookingApp">
// // //   <trk>
// // //     <name> $date</name>
// // //     <trkseg>
...
// // // </gpx>''';
// // //
// // //         await dailyFile.writeAsString(gpxHeader);
// // //         debugPrint("✅ New daily GPX file created: $filePath");
// // //       }
// // //     } catch (e) {
// // //       debugPrint("❌ Error ensuring daily GPX file: $e");
// // //     }
// // //   }
// // //
// // // // Method 3: Single daily GPX file save (SERVER KE LIYE)
// // //   Future<void> saveDailyGPXToServer() async {
// // //     try {
// // //       debugPrint("🟦 Starting daily GPX save to server...");
// // //
// // //       // 1. Ensure daily file exists
// // //       await ensureDailyGPXFile();
// // //
// // //       // 2. Get today's GPX file path
// // //       final date = DateFormat('dd-MM-yyyy').format(DateTime.now());
// // //       final downloadDirectory = await getDownloadsDirectory();
// // //       final gpxFilePath = '${downloadDirectory!.path}/$date.gpx';
// // //
// // //       File dailyFile = File(gpxFilePath);
// // //
// // //       if (!dailyFile.existsSync()) {
// // //         debugPrint('❌ Daily GPX file does not exist');
// // //         return;
// // //       }
// // //
// // //       // 3. Calculate total distance from daily file
// // //       double totalDistance = await calculateTotalDistance(gpxFilePath);
// // //       debugPrint("📏 Daily Total Distance: $totalDistance km");
// // //
// // //       // 4. Prepare file for upload
// // //       List<int> gpxBytesList = await dailyFile.readAsBytes();
// // //       Uint8List gpxBytes = Uint8List.fromList(gpxBytesList);
// // //
// // //       // 5. Generate location ID
// // //       await _loadCounter();
// // //       final locationId = generateNewOrderId(user_id);
// // //
...
// // //         user_id: user_id.toString(),
// // //         total_distance: totalDistance.toString(),
// // //         file_name: "$date.gpx", // Daily file name
// // //         booker_name: userName,
// // //         body: gpxBytes,
// // //       ));
// // //
...
// // //       await locationRepository.postDataFromDatabaseToAPI();
// // //
// // //       debugPrint("✅ Daily GPX file saved to server successfully");
// // //       debugPrint("📁 File: $date.gpx");
// // //       debugPrint("📊 Total Distance: $totalDistance km");
// // //
// // //     } catch (e) {
// // //       debugPrint("❌ Error in saveDailyGPXToServer: $e");
// // //     }
// // //   }
// // //
// // //   // Clear all central points (for testing)
