...
// // //   }
// // //
// // //   // ✅ IMPROVED: Calculate shift distance with better error handling
// // //   Future<double> calculateShiftDistance(DateTime shiftStartTime) async {
// // //     try {
// // //       debugPrint("📍 [SHIFT DISTANCE] Calculating for shift starting at: ${DateFormat('HH:mm:ss').format(shiftStartTime)}");
// // //
// // //       // Get today's date
// // //       final date = DateFormat('dd-MM-yyyy').format(DateTime.now());
// // //       final downloadDirectory = await getDownloadsDirectory();
...
// // //         debugPrint("📍 Using consolidated GPX file");
// // //         String gpxContent = await consolidatedFile.readAsString();
// // //         totalDistance = await _calculateDistanceFromGPXContent(gpxContent, shiftStartTime);
// // //       } else {
// // //         // Fallback to user-specific file
// // //         final userFilePath = "${downloadDirectory!.path}/track_${user_id}_$date.gpx";
// // //         File userFile = File(userFilePath);
// // //
// // //         if (userFile.existsSync()) {
// // //           debugPrint("📍 Using user-specific GPX file");
// // //           String gpxContent = await userFile.readAsString();
// // //           totalDistance = await _calculateDistanceFromGPXContent(gpxContent, shiftStartTime);
// // //         } else {
// // //           debugPrint("❌ No GPX file found for distance calculation");
// // //           return 0.0;
// // //         }
// // //       }
// // //
// // //       debugPrint("📍 [SHIFT DISTANCE] Final: ${totalDistance.toStringAsFixed(3)} km");
// // //       return totalDistance;
// // //
// // //     } catch (e) {
...
// // //   }
// // //
// // // // Helper method to calculate distance from GPX content
// // //   Future<double> _calculateDistanceFromGPXContent(String gpxContent, DateTime shiftStartTime) async {
// // //     if (gpxContent.isEmpty) return 0.0;
// // //
// // //     Gpx gpx = GpxReader().fromString(gpxContent);
// // //     double shiftDistance = 0.0;
// // //     int totalPoints = 0;
// // //     int pointsAfterStart = 0;
// // //
// // //     for (var track in gpx.trks) {
// // //       for (var segment in track.trksegs) {
// // //         totalPoints += segment.trkpts.length;
...
// // //     }
// // //
// // //     debugPrint("📍 Points in file: $totalPoints, Points after shift start: $pointsAfterStart");
...
// // //   }
// // //
// // //   // ✅ ADD: Force distance calculation from current GPX file
// // //   Future<double> forceDistanceCalculation(DateTime shiftStartTime) async {
// // //     try {
// // //       debugPrint("📍 [FORCE] Calculating distance from shift start: ${DateFormat('HH:mm:ss').format(shiftStartTime)}");
// // //
// // //       // First consolidate all GPX data
// // //       await consolidateDailyGPXData();
// // //
// // //       // Get the consolidated file path
// // //       final date = DateFormat('dd-MM-yyyy').format(DateTime.now());
// // //       final downloadDirectory = await getDownloadsDirectory();
// // //       final consolidatedFilePath = "${downloadDirectory!.path}/track$date.gpx";
// // //
// // //       File file = File(consolidatedFilePath);
// // //       if (!file.existsSync()) {
// // //         debugPrint("❌ [FORCE] No consolidated GPX file found");
// // //         return 0.0;
// // //       }
// // //
// // //       // Read the GPX file
...
// // //       int pointsAfterStart = 0;
// // //
// // //       // Calculate distance for points after shift start
// // //       for (var track in gpx.trks) {
// // //         for (var segment in track.trksegs) {
// // //           List<Wpt> shiftPoints = segment.trkpts.where((point) {
// // //             return point.time != null && point.time!.isAfter(shiftStartTime);
// // //           }).toList();
// // //
// // //           pointsAfterStart += shiftPoints.length;
// // //
// // //           for (int i = 0; i < shiftPoints.length - 1; i++) {
// // //             double distance = calculateDistance(
// // //               shiftPoints[i].lat?.toDouble() ?? 0.0,
...
// // //       }
// // //
// // //       debugPrint("📍 [FORCE] Distance calculated: ${totalDistance.toStringAsFixed(3)} km");
// // //       debugPrint("📍 [FORCE] Points after shift start: $pointsAfterStart");
// // //
// // //       return totalDistance;
// // //     } catch (e) {
// // //       debugPrint("❌ [FORCE] Error in forceDistanceCalculation: $e");
// // //       return 0.0;
// // //     }
// // //   }
// // // }
