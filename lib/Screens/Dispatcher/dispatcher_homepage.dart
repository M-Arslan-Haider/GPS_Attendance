...
import 'package:order_booking_app/screens/HomeScreenComponents/navbar.dart';
import 'package:order_booking_app/screens/HomeScreenComponents/profile_section.dart';
...
import 'package:order_booking_app/ViewModels/ScreenViewModels/signup_view_model.dart';
import 'package:order_booking_app/ViewModels/location_view_model.dart';
import '../../Databases/util.dart';
import '../Summary Reporsts/Dispatcher_Reports/Dispatchreportscreen.dart';
import '../Summary Reporsts/Dispatcher_Reports/NotDispatchReportScreen.dart';
import '../Summary Reporsts/Dispatcher_Reports/RecoveryDispatchReportScreen.dart';
import '../recovery_form_screen.dart';
import 'Order_Dispatch/dispatcher_action_screen.dart';
import 'Recovery_Dispatch/DispatchRecoveryFormScreen.dart';
import 'Return_Dispatch/return_dispatch_order.dart';
...
class _DispatcherHomepageState extends State<DispatcherHomepage> {
          ...
          body: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                // Summary Section
                _buildSummarySection(horizontalPadding: 15),
                const SizedBox(height: 24),
        ...
        children: [
          ...
          _actionCard(
            ...
            onTap: () {
              _checkClockInBeforeAction(
                  action: () {
                    Get.to(() => DispatcherReturnFormScreen());
                  },
                  actionName: 'return'
              );
            },
  ...
  Widget _buildSummarySection({required double horizontalPadding}) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 10),
          SizedBox(
            height: 95, // Adjusted height for 2 rows
            child: Container(
              ...
              child: GridView(
                ...
                gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                  ...
                  crossAxisSpacing: 8,
                  mainAxisSpacing: 5,
                  childAspectRatio: 1.12, // Slightly taller items
                ),
                children: [
                  GestureDetector(
                    onTap: () => Get.to(() => const DispatchReportScreen()),
                    child: _summaryGridItem(
                      "Dispatched",
                      dispatchedCount,
                    ...
                    GestureDetector(
                    onTap: () => Get.to(() => const NotDispatchReportScreen()),
    child: _summaryGridItem(
                    "Not Dispatched",
                    cancelledCount,
                  ...
                  _summaryGridItem(
                    ...
                    GestureDetector(
    onTap: () => Get.to(() => const RecoveryDispatchReportScreen()),
    child: _summaryGridItem(
                    "Recovery",
                    recoveryCount,
  ...
  Widget _summaryGridItem(String label, int value, IconData icon,
