...
// //     }
// //
// //     // ✅ CHECK: Are we starting a new shift?
// //     await _checkForNewShift();
// //
...
// //     try {
// //       debugPrint("📍 [LOCATION SERVICE] Calculating current distance...");
// //
// //       // Calculate from current segment only
// //       double currentShiftDistance = await getCurrentShiftDistance();
// //
// //       debugPrint("📏 [LOCATION SERVICE] Current shift distance: ${currentShiftDistance.toStringAsFixed(3)} km");
// //       debugPrint("   - Points in segment: ${segment.trkpts.length}");
// //
// //       // Save to SharedPreferences for verification
// //       SharedPreferences prefs = await SharedPreferences.getInstance();
// //       await prefs.setDouble('lastCalculatedDistance', currentShiftDistance);
// //
// //       return currentShiftDistance;
// //
// //     } catch (e) {
// //       debugPrint("❌ [LOCATION SERVICE] Error calculating distance: $e");
// //       return 0.0;
// //     }
// //   }
// //
...
// //   }
// //
// //   // ✅ NEW: Reset distance for new shift - CALL THIS ON CLOCK-IN
// //   void resetDistanceForNewShift() {
// //     totalDistance = 0.0;
// //     lastTrackPoint = null;
// //     _isFirstLocationRecorded = false;
// //
// //     // Also reset in SharedPreferences
// //     SharedPreferences.getInstance().then((prefs) async {
// //       await prefs.remove('accumulatedDistance');
// //       await prefs.remove('previousLatLng');
// //       await prefs.setDouble('sessionStartDistance', 0.0);
// //     });
// //
// //     debugPrint("🔄 [LOCATION SERVICE] Distance RESET to 0");
// //     debugPrint("   - Total distance: 0.0 km");
// //     debugPrint("   - Last track point: Cleared");
// //     debugPrint("   - First location recorded: false");
// //   }
// //
// //   // ✅ NEW: Get immediate current distance without any delays
// //   Future<double> getImmediateDistance() async {
// //     try {
// //       debugPrint("📍 [LOCATION SERVICE] Getting immediate distance...");
// //
// //       // Return current in-memory distance
// //       double currentDistance = totalDistance;
// //
// //       // Verify with file if available
// //       if (file.existsSync() && segment.trkpts.length > 1) {
// //         try {
// //           double fileDistance = await _calculateDistanceFromSegment(segment);
// //           if (fileDistance > currentDistance) {
// //             currentDistance = fileDistance;
// //           }
// //         } catch (e) {
// //           debugPrint("⚠️ Could not verify with file: $e");
// //         }
// //       }
// //
// //       debugPrint("   📏 Immediate distance: ${currentDistance.toStringAsFixed(3)} km");
// //       debugPrint("   📊 Points in segment: ${segment.trkpts.length}");
// //
...
// //       return totalDistance; // Return what we have in memory
// //     }
// //   }
// //   // ✅ NEW: Calculate distance from a single segment
// //   double _calculateDistanceFromSegment(Trkseg segment) {
// //     if (segment.trkpts.length < 2) return 0.0;
// //
// //     double segmentDistance = 0.0;
// //
// //     for (int i = 0; i < segment.trkpts.length - 1; i++) {
...
// //   }
// //
// //   // ✅ NEW: Check if we're starting a new shift
// //   Future<void> _checkForNewShift() async {
// //     try {
// //       SharedPreferences prefs = await SharedPreferences.getInstance();
// //       String? lastClockOutTimeString = prefs.getString('lastClockOutTime');
// //       String? currentSessionStartString = prefs.getString('currentSessionStart');
...
// //         DateTime currentSessionStart = DateTime.parse(currentSessionStartString);
// //
// //         // If last clock-out was within 30 seconds, we might be in the same session
// //         Duration timeSinceLastClockOut = currentSessionStart.difference(lastClockOutTime);
// //
// //         if (timeSinceLastClockOut.inSeconds.abs() < 30) {
// //           debugPrint("🔄 Same session continuing - not resetting distance");
// //           return;
// //         }
// //
// //         // If more than 5 minutes since last session, start fresh
// //         if (timeSinceLastClockOut.inMinutes > 5) {
// //           debugPrint("🔄 New shift detected - resetting distance");
// //           await _resetForNewShift();
// //         }
// //       } else {
// //         debugPrint("🔄 No previous session found - starting fresh");
// //         await _resetForNewShift();
// //       }
// //     } catch (e) {
// //       debugPrint("❌ Error checking for new shift: $e");
// //     }
// //   }
// // // ✅ NEW: Reset everything for new shift
// //   Future<void> _resetForNewShift() async {
// //     try {
// //       debugPrint("🔄 Preparing for new shift...");
// //
// //       // 1. Save current segment if it has data
// //       if (segment.trkpts.isNotEmpty) {
// //         _segments.add(segment);
// //         debugPrint("   💾 Saved current segment with ${segment.trkpts.length} points");
// //       }
// //
// //       // 2. Create new segment for new shift
// //       segment = Trkseg();
// //       if (track.trksegs.isEmpty) {
// //         track.trksegs = [segment];
// //       } else {
...
// //       await prefs.setDouble('sessionStartDistance', 0.0);
// //
// //       debugPrint("✅ Ready for new shift");
// //       debugPrint("   - Total distance: 0.0 km");
// //       debugPrint("   - New segment created");
// //       debugPrint("   - Last point cleared");
// //
// //     } catch (e) {
// //       debugPrint("❌ Error resetting for new shift: $e");
// //     }
// //   }
// //   // ✅ NEW: Get current shift distance only (not accumulated)
// //   Future<double> getCurrentShiftDistance() async {
// //     try {
// //       double shiftDistance = 0.0;
// //
// //       // Calculate distance from current segment only
// //       if (segment.trkpts.length > 1) {
// //         shiftDistance = _calculateDistanceFromSegment(segment);
// //       }
// //
// //       debugPrint("📏 Current shift distance: ${shiftDistance.toStringAsFixed(3)} km");
// //       debugPrint("   - Points in current segment: ${segment.trkpts.length}");
// //       debugPrint("   - Total segments: ${track.trksegs.length}");
// //
// //       return shiftDistance;
// //
// //     } catch (e) {
// //       debugPrint("❌ Error getting current shift distance: $e");
// //       return totalDistance; // Fallback to total distance
// //     }
// //   }
// //
// //   // In location00.dart, rename one of the resetDistance methods:
// //
// // // Option 1: Keep both but rename one
// // // Current method at line 661 - rename to resetDistanceForNewShift
// // //   void resetDistanceForNewShift() {
// // //     totalDistance = 0.0;
// // //     lastTrackPoint = null;
// // //     _isFirstLocationRecorded = false;
...
// // //     });
// // //
// // //     debugPrint("🔄 [LOCATION SERVICE] Distance RESET to 0 for new shift");
// // //     debugPrint("   - Total distance: 0.0 km");
// // //     debugPrint("   - Last track point: Cleared");
// // //     debugPrint("   - First location recorded: false");
// // //   }
// //
// // // Option 2: Or merge them into one method
// // //   void resetDistance() {
// // //     totalDistance = 0.0;
// // //     lastTrackPoint = null;
// // //     _isFirstLocationRecorded = false;
...
// // //       await prefs.remove('accumulatedDistance');
// // //       await prefs.remove('previousLatLng');
// // //       await prefs.remove('sessionStartDistance');
// // //     });
// // //
// // //     debugPrint("🔄 [LOCATION SERVICE] Distance COMPLETELY RESET to 0");
// // //   }
// //
// // // Then update TimerCard to use the correct method name
// // }
//
// import 'dart:async' show Future, StreamSubscription, Completer;
// import 'dart:io';
...
//
//
//   // ADD this method to LocationService class in location00.dart
//   Future<double> getAndSaveFinalDistance() async {
//     try {
//       // Calculate distance from both memory and file
//       double finalDistance = await calculateCurrentDistance();
//
//       SharedPreferences prefs = await SharedPreferences.getInstance();
//
//       // ✅ SAVE to multiple places to ensure it's not lost
//       await prefs.setDouble('finalCalculatedDistance', finalDistance);
//       await prefs.setDouble('lastClockOutDistance', finalDistance);
//       await prefs.setDouble('totalDistance', finalDistance);
//
//       // Also save as string for easy access
//       await prefs.setString('distanceString', finalDistance.toStringAsFixed(3));
//
//       debugPrint("💾 [DISTANCE SAVED] Final distance saved: ${finalDistance.toStringAsFixed(3)} km");
//
//       return finalDistance;
//     } catch (e) {
//       debugPrint("❌ Error saving final distance: $e");
//       return totalDistance;
//     }
//   }
// }
